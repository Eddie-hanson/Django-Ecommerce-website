"""
Django settings for Luex project.
...
SECRET_KEY = 'django-insecure-oysak)3bgl6g7vm_fz6rx)*zko(q42rh2l$t5&t@27*so8e*%v'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'website.context_processor.counter',
            ],
        },
    },
]

WSGI_APPLICATION = 'Luex.wsgi.application'
